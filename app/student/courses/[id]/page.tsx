  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white p-8">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {/* Tabs */}
        <div className="bg-[#1a1a1a]/60 border border-white/10 rounded-xl p-2 backdrop-blur-md flex gap-2">
          <button
        ...
        {activeTab === "overview" && (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="bg-[#1a1a1a]/60 border border-white/10 rounded-xl p-6 backdrop-blur-md hover:shadow-[0_0_25px_rgba(255,255,255,0.1)] transition-all">
              ...
              <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-6 backdrop-blur-md">
                ...
                <p className="text-3xl font-bold text-green-300">{stats.attended}</p>
              </div>
              ...
              <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-6 backdrop-blur-md">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm text-purple-400">Attendance Rate</p>
                  <TrendingUp className="text-purple-400" size={20} />
                </div>
                <p className="text-3xl font-bold text-purple-300">{stats.attendanceRate}%</p>
              </div>
            </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-mono text-white bg-[#0a0a0a] px-3 py-1 rounded-lg inline-block border border-white/10">
                        {course.entryCode}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm text-gray-400">Academic Period</p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white">{course.semester.academicYear.program.name}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white">{course._count.students} students</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white font-medium">{course.teacher.user.name}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white">{course.teacher.user.email}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white">{course.teacher.department.name}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {stats.totalSessions > 0 && (
              <div className="bg-[#1a1a1a]/60 border border-white/10 rounded-xl p-6 backdrop-blur-md shadow-[0_0_25px_rgba(255,255,255,0.05)]">
                ...
                <div className="mb-4">
                  ...
                  <div className="w-full bg-[#0a0a0a] rounded-full h-3 border border-white/10 overflow-hidden">
                    <div
                ...
                <div className="grid grid-cols-3 gap-4 mt-6">
                  <div className="text-center">
                    <p className="text-gray-400 text-sm mb-1">Sessions Held</p>
              ...
              <div className="space-y-3">
                {attendance
                  ...
                  .map((record) => (
                    <div
                      key={record.id}
                      className="flex items-center justify-between p-4 bg-[#0a0a0a] border border-white/10 rounded-lg hover:border-blue-500/30 transition-all"
                    >
