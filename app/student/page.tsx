...
import { BookOpen, ClipboardList, User, GraduationCap, BarChart3, Target, CheckCircle2 } from "lucide-react";
...
export default function StudentDashboard() {
  ...
  const statCards = [
    { title: "My Courses", value: stats.totalCourses, icon: <GraduationCap className="text-blue-400" size={28} /> },
    { title: "Attendance %", value: `${stats.attendancePercentage}%`, icon: <BarChart3 className="text-purple-400" size={28} /> },
    { title: "Classes Attended", value: stats.totalPresent, icon: <CheckCircle2 className="text-green-400" size={28} /> },
  ];
    ...
    <div className="space-y-8 text-white">
      ...
      <div>
        ...
        <p className="text-gray-400 mt-2">
          Welcome back! Manage your courses and attendance easily.
        </p>
      </div>
      ...
      <div className="bg-[#141414]/80 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-[0_0_25px_rgba(255,255,255,0.05)]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            {
              icon: <BookOpen className="text-green-400" size={26} />,
              title: "My Courses",
              desc: "View enrolled courses",
              onClick: () => router.push("/student/courses"),
            },
            {
              icon: <ClipboardList className="text-purple-400" size={26} />,
              title: "Attendance History",
              desc: "Check your past attendance",
              onClick: () => router.push("/student/history"),
            },
            {
              icon: <User className="text-orange-400" size={26} />,
              title: "My Profile",
      ...
      <div className="bg-[#141414]/80 border border-white/10 rounded-2xl p-6 backdrop-blur-md shadow-[0_0_25px_rgba(255,255,255,0.05)]">
        ...
        <ol className="list-decimal pl-6 space-y-2 text-gray-300">
          ...
          <li>Enter the <strong>Entry Code</strong> provided by your teacher.</li>
          <li>Take a clear selfie or upload a photo showing your face.</li>
          <li>Submit and wait for teacher approval.</li>
          <li>Check <strong>Attendance History</strong> to view your records.</li>
        </ol>
      </div>
    </div>
  );
